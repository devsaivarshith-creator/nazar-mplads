...
export const ALL_INDIA_MPS: MPProfile[] = [
  ...
  // 18. Kangana Ranaut (BJP - Mandi, Himachal Pradesh)
  {
    id: "MP-HP-MND-19",
    name: "Kangana Ranaut",
    party: "BJP",
    ...
    questions_count: 65,
    private_member_bills: 0,
    education: "Higher Secondary (Class XII), DAV Model School, Sector 15, Chandigarh",
    profession: "Actor, Filmmaker & Public Representative",
    assets_declared: 915000000, // ₹91.50 Cr declared in 2024 affidavit
    criminal_cases: 8, // Primarily political/speech and defamation notices
    sanctioned_amount: 250000000,
    recommended_amount: 268000000,
    expenditure_amount: 182000000,
    ...
    flagged_observations: 2,
    top_sectors: [
      { sector: "Disaster Retaining Walls & Flood Mitigation", amount: 96000000, count: 68, percentage: 38.4 },
      { sector: "Himalayan Hill Roads & Bridges", amount: 64000000, count: 54, percentage: 25.6 },
      { sector: "Traditional Wool Weaving Clusters", amount: 42000000, count: 38, percentage: 16.8 },
      { sector: "Health Dispensaries in Remote Valleys", amount: 30000000, count: 26, percentage: 12.0 },
      { sector: "Solar Micro-Grids for Snowbound Hamlets", amount: 18000000, count: 12, percentage: 7.2 }
    ],
    implementing_agencies: ["HP Public Works Department (HPPWD Mandi)", "District Rural Development Agency Kullu/Mandi", "HP Jal Shakti Vibhag"],
    key_priorities: ["RCC retaining walls along flood-prone Beas river tributaries", "Cold-weather community shelters in high-altitude passes", "Local artisan handloom training centers"],
    observations_summary: "14 works delayed past scheduled timelines due to Himalayan winter closures and monsoon landslide clearance.",
    avatar_initials: "KR",
    wikipedia_url: "https://en.wikipedia.org/wiki/Kangana_Ranaut",
    sansad_url: "https://sansad.in/ls/members/biography/5540",
    prs_url: "https://prsindia.org/mptrack/18-lok-sabha/kangana-ranaut"
  },

  // 19. Hema Malini (BJP - Mathura, Uttar Pradesh)
  {
    id: "MP-UP-MTH-20",
    name: "Hema Malini",
    party: "BJP",
    ...
    questions_count: 110,
    private_member_bills: 1,
    education: "Higher Secondary, Andhra Education Society, New Delhi; Hon. Ph.D. in Arts",
    profession: "Classical Dancer, Film Actor & Politician",
    assets_declared: 2780000000, // ₹278.0 Cr declared in 2024 affidavit
    criminal_cases: 0,
    sanctioned_amount: 250000000,
    recommended_amount: 270000000,
    expenditure_amount: 225000000,
    ...
    flagged_observations: 1,
    top_sectors: [
      { sector: "Heritage Tourism & Pilgrim Civic Amenities", amount: 98000000, count: 72, percentage: 39.2 },
      { sector: "Yamuna Ghat Cleanliness & Waste Treatment", amount: 62000000, count: 48, percentage: 24.8 },
      { sector: "Rural Drinking Water Plants (RO Water)", amount: 44000000, count: 52, percentage: 17.6 },
      { sector: "Solar High-Mast Streetlights in Braj", amount: 28000000, count: 44, percentage: 11.2 },
      { sector: "Government School Classrooms", amount: 18000000, count: 32, percentage: 7.2 }
    ],
    implementing_agencies: ["Braj Teerth Vikas Parishad", "Mathura-Vrindavan Municipal Corporation", "UP Jal Nigam"],
    key_priorities: ["Pilgrim rest sheds and bio-toilets on 84-Kosi Parikrama route", "Solar streetlights across Braj rural mandals"],
    observations_summary: "90% expenditure rate; 8 works in Vrindavan core zone delayed due to archaeological heritage zoning clearances.",
    avatar_initials: "HM",
    wikipedia_url: "https://en.wikipedia.org/wiki/Hema_Malini",
    sansad_url: "https://sansad.in/ls/members/biography/4679",
    prs_url: "https://prsindia.org/mptrack/18-lok-sabha/hema-malini"
  },

  // 20. Kalyan Banerjee (TMC - Sreerampur, West Bengal)
  {
    id: "MP-WB-SRP-21",
    ...
    term: "18th Lok Sabha (4th Term) — Senior Advocate Supreme Court",
    attendance_rate: 86,
    debates_count: 122,
    questions_count: 194,
    private_member_bills: 3,
    education: "B.Com., LL.B., Calcutta University; Senior Advocate Supreme Court & Calcutta HC",
    profession: "Senior Advocate & Political Leader",
    assets_declared: 184000000, // ₹18.4 Cr
    criminal_cases: 4, // Demonstration and political agitation notices
    sanctioned_amount: 250000000,
    recommended_amount: 265000000,
    expenditure_amount: 216000000,
    ...
    flagged_observations: 2,
    top_sectors: [
      { sector: "Jute Mill Worker Colonies Civic Facilities", amount: 94000000, count: 68, percentage: 37.6 },
      { sector: "Urban Drainage & Stormwater Sluices", amount: 62000000, count: 52, percentage: 24.8 },
      { sector: "Primary Healthcare Centers", amount: 46000000, count: 42, percentage: 18.4 },
      { sector: "Drinking Water Pipelines", amount: 30000000, count: 44, percentage: 12.0 },
      { sector: "Solar Lighting in Industrial Wards", amount: 18000000, count: 32, percentage: 7.2 }
    ],
    implementing_agencies: ["Hooghly Zilla Parishad", "Sreerampur Municipality", "Kolkata Metropolitan Dev Authority (KMDA)"],
    key_priorities: ["Civic infrastructure for industrial worker settlements", "Anti-waterlogging drainage canals along GT Road"],
    observations_summary: "9 delayed projects along river Hooghly embankments awaiting high-tide dry weather construction slots.",
    avatar_initials: "KB",
    wikipedia_url: "https://en.wikipedia.org/wiki/Kalyan_Banerjee_(politician)",
    sansad_url: "https://sansad.in/ls/members/biography/4389",
    prs_url: "https://prsindia.org/mptrack/18-lok-sabha/kalyan-banerjee"
  },

  // 21. Manoj Tiwari (BJP - North East Delhi)
  {
    id: "MP-DL-NED-22",
    name: "Manoj Tiwari",
    party: "BJP",
    ...
    questions_count: 240,
    private_member_bills: 2,
    education: "M.P.Ed. & B.P.Ed., Banaras Hindu University (BHU)",
    profession: "Singer, Actor & Public Representative",
    assets_declared: 285000000, // ₹28.5 Cr
    criminal_cases: 1,
    sanctioned_amount: 250000000,
    recommended_amount: 275000000,
    expenditure_amount: 228000000,
    ...
    flagged_observations: 1,
    top_sectors: [
      { sector: "Slum & Unauthorized Colony Internal Concrete Roads", amount: 98000000, count: 84, percentage: 39.2 },
      { sector: "Public Open Gyms & Park Development", amount: 58000000, count: 56, percentage: 23.2 },
      { sector: "Municipal Health Dispensaries", amount: 44000000, count: 42, percentage: 17.6 },
      { sector: "High-Mast LED Security Lighting", amount: 32000000, count: 52, percentage: 12.8 },
      { sector: "School Computer Classrooms", amount: 18000000, count: 18, percentage: 7.2 }
    ],
    implementing_agencies: ["Municipal Corporation of Delhi (MCD)", "Delhi Development Authority (DDA)", "Delhi Jal Board"],
    key_priorities: ["Paved roads in congested urban resettlement colonies", "Open air fitness parks and senior citizen gazebos"],
    observations_summary: "High fund deployment rate (91.2%); 7 works in Yamuna flood plain zones delayed pending DJB clearance.",
    avatar_initials: "MT",
    wikipedia_url: "https://en.wikipedia.org/wiki/Manoj_Tiwari",
    sansad_url: "https://sansad.in/ls/members/biography/4675",
    prs_url: "https://prsindia.org/mptrack/18-lok-sabha/manoj-tiwari"
  },

  // 22. Chirag Paswan (LJPRV - Hajipur, Bihar)
  {
    id: "MP-BR-HAJ-23",
    name: "Chirag Paswan",
    party: "LJPRV",
    ...
    state: "Bihar",
    constituency: "Hajipur",
    term: "18th Lok Sabha (3rd Term) — Union Cabinet Minister",
    attendance_rate: 94,
    debates_count: 52,
    questions_count: 148,
    private_member_bills: 1,
    education: "B.Tech (Coursework 3rd Year), Institute of Engineering and Technology, Jhansi",
    profession: "Union Minister for Food Processing Industries & Political Leader",
    assets_declared: 112000000, // ₹11.2 Cr
    criminal_cases: 0,
    sanctioned_amount: 250000000,
    recommended_amount: 270000000,
    expenditure_amount: 214000000,
    ...
    flagged_observations: 2,
    top_sectors: [
      { sector: "Banana & Agro-Cluster Farmer Facilities", amount: 92000000, count: 68, percentage: 36.8 },
      { sector: "Rural Concrete Road Connectivity", amount: 64000000, count: 62, percentage: 25.6 },
      { sector: "Piped Drinking Water Community ROs", amount: 46000000, count: 48, percentage: 18.4 },
      { sector: "Community Welfare & Youth Skill Centers", amount: 30000000, count: 32, percentage: 12.0 },
      { sector: "Solar Electrification", amount: 18000000, count: 20, percentage: 7.2 }
    ],
    implementing_agencies: ["Rural Works Department (RWD Bihar)", "Vaishali District Administration", "Panchayati Raj Bihar"],
    key_priorities: ["All-weather access roads to banana producing farmer mandis", "Clean drinking water in flood-affected panchayats"],
    observations_summary: "11 delayed works in river Gandak basin due to recurrent seasonal waterlogging during monsoons.",
    avatar_initials: "CP",
    wikipedia_url: "https://en.wikipedia.org/wiki/Chirag_Paswan",
    sansad_url: "https://sansad.in/ls/members/biography/4672",
    prs_url: "https://prsindia.org/mptrack/18-lok-sabha/chirag-paswan"
  },

  // 23. Nitin Gadkari (BJP - Nagpur, Maharashtra)
  {
    id: "MP-MH-NGP-24",
    name: "Nitin Gadkari",
    party: "BJP",
    ...
    attendance_rate: 100, // Union Minister exemption
    debates_count: 24,
    questions_count: 0, // Ministers do not table questions
    private_member_bills: 0,
    education: "M.Com., LL.B., G.S. College of Commerce & University College of Law, Nagpur",
    profession: "Union Cabinet Minister, Industrialist & Social Worker",
    assets_declared: 280000000, // ₹28.0 Cr
    criminal_cases: 0,
    sanctioned_amount: 250000000,
    recommended_amount: 250000000,
    expenditure_amount: 245000000,
    ...
    flagged_observations: 0,
    top_sectors: [
      { sector: "Modern Urban Mobility & Multi-Modal Walkways", amount: 96000000, count: 54, percentage: 38.4 },
      { sector: "Bio-Fuel & Solar Public Infrastructure", amount: 68000000, count: 48, percentage: 27.2 },
      { sector: "Super-Specialty Hospital Diagnostic Wings", amount: 48000000, count: 38, percentage: 19.2 },
      { sector: "Model Municipal School Science Labs", amount: 24000000, count: 42, percentage: 9.6 },
      { sector: "Nag River Ecology & Lake Beautification", amount: 14000000, count: 26, percentage: 5.6 }
    ],
    implementing_agencies: ["Nagpur Municipal Corporation (NMC)", "Nagpur Improvement Trust (NIT)", "Maharashtra PWD"],
    key_priorities: ["Modernization of municipal primary health centers with oxygen/dialysis support", "Solar-powered city green corridors"],
    observations_summary: "Exceptional 98.0% utilization rate with fast milestone sign-offs; 2 works delayed for metro rail right-of-way alignment.",
    avatar_initials: "NG",
    wikipedia_url: "https://en.wikipedia.org/wiki/Nitin_Gadkari",
    sansad_url: "https://sansad.in/ls/members/biography/4682",
    prs_url: "https://prsindia.org/mptrack/18-lok-sabha/nitin-gadkari"
  },

  // 24. Supriya Sule (NCP-SP - Baramati, Maharashtra)
  {
    id: "MP-MH-BRM-25",
    name: "Supriya Sule",
    party: "NCP-SP",
    ...
    state: "Maharashtra",
    constituency: "Baramati",
    term: "18th Lok Sabha (4th Term) — Sansad Ratna Hall of Fame",
    attendance_rate: 93,
    debates_count: 178,
    questions_count: 420,
    private_member_bills: 14,
    education: "B.Sc. in Microbiology, Jai Hind College, Mumbai University",
    profession: "Agriculturist, Social Worker & Parliamentarian",
    assets_declared: 1660000000, // ₹166.0 Cr
    criminal_cases: 0,
    sanctioned_amount: 252000000,
    recommended_amount: 278000000,
    ...
    flagged_observations: 1,
    top_sectors: [
      { sector: "Water Conservation & Drip Irrigation Farm Ponds", amount: 94000000, count: 82, percentage: 37.3 },
      { sector: "Women Self-Help Group (Bachat Gat) Training Centers", amount: 64000000, count: 74, percentage: 25.4 },
      { sector: "Rural Primary Healthcare & Telemedicine", amount: 48000000, count: 46, percentage: 19.0 },
      { sector: "Zilla Parishad Digital Classrooms", amount: 30000000, count: 52, percentage: 11.9 },
      { sector: "Rural Concrete Farm Roads", amount: 16000000, count: 31, percentage: 6.4 }
    ],
    implementing_agencies: ["Pune Zilla Parishad", "Maharashtra Rural Development Dept", "Baramati Municipal Council"],
    key_priorities: ["Drought mitigation and farm pond percolation tanks in rain-shadow pockets", "Sanitary pad and health units in rural schools"],
    observations_summary: "Consistently top-tier parliamentary engagement (420 questions); 5 works in Indapur taluk delayed due to canal lining works.",
    avatar_initials: "SS",
    wikipedia_url: "https://en.wikipedia.org/wiki/Supriya_Sule",
